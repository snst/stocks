...
ALL_COLUMNS = [D_DOPEN, D_CLOSE, D_CLOSE_SCALED, D_CLOSE_DELTA_PERCENT, D_HIGH, D_LOW, D_LOW_3, D_HIGH_3, D_SPREAD, D_SPREAD_BAR, D_SELL_BALANCE, D_TAX_PROFIT, D_TAX_LOSS,
